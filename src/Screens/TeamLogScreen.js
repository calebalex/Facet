...
const TeamLogScreen = ({navigation, route}) => {
    const teamID = route.params.teamID
    const entryID = route.params.entry.entry_ID
    const [logs] = useCollectionData(collection(firestore, "Teams", teamID, "Entries", entryID, "Service-Records"));
    ...
    const updateLog = (updatedLog) => {
        ...
        const docRef = doc(firestore, "Teams", teamID, "Entries", entryID, "Service-Records", updatedLog.id);
    ...
    const addLog = (newLog) => {
        const newDocRef = doc(collection(firestore, "Teams", teamID, "Entries", entryID, "Service-Records"));
    ...
    const deleteLog = (log) => {
        const docRef = doc(firestore, "Teams", teamID, "Entries", entryID, "Service-Records", log.id)
